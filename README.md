...
This dataset provides a comprehensive overview of electric vehicle (EV) sales across various states in India, containing 96,846 rows and 8 columns of detailed information. It offers key insights into regional EV adoption patterns, with data carefully preprocessed and cleaned to remove any null values. The dataset includes state-wise EV sales quantities, vehicle types, and categories, making it ideal for geographic market segmentation and trend analysis. Its versatility allows for predictive modeling, infrastructure planning, and strategic decision-making in the expanding EV sector across different regions in India.
